...
#set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports bcd_select]
#set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports {display_select[0]}]
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports bcd_select]
